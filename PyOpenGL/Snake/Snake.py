...
class Testing:
    ...
    cxx,cyy,czz=SIZE[0]/2,SIZE[1]/2,30
    ...
    def animate(self,FPS=20):
        ...
        self.fxx=self.fxx+(self.SNAKE[0][0]-self.fxx)/10.0
        self.fyy=self.fyy+(self.SNAKE[0][1]-self.fyy)/10.0
    ...
    def draw(self):
        ...
        try:
            ...
            glTranslate(2,2,0)
            self.drawString("SCORE: "+str(self.POINTS))
